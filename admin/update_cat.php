...
<div id="content">	
	<div class="text">
		...
		if (isset($title) && isset($meta_d) && isset($meta_k) && isset($text))
		{
			...
			if ($result)
				{echo "Ваша категория успешно обновлена!";}
			else
				{echo "Ваша категория не обновлена!!!";}
		}
		else 
		{
			echo "<p>Вы ввели не всю информацию, по-этому категория Ваша не может быть обновлена.";   
		}  		 
		?>
	</div>						
